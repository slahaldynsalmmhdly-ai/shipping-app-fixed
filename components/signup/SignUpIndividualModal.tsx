...
interface SignUpIndividualModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSignupSuccess: (data: { token: string; user: any }) => void;
}

const SignUpIndividualModal: React.FC<SignUpIndividualModalProps> = ({ isOpen, onClose, onSignupSuccess }) => {
